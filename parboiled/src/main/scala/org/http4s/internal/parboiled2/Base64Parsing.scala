...
private[http4s] trait Base64Parsing { this: Parser =>
  ...
  /**
   * Parses a org.http4s.internal.parboiled2.util.Base64.custom()-encoded string and decodes it onto the value stack.
   */
  def base64CustomString: Rule1[Array[Byte]] = base64StringOrBlock(customAlphabet, customStringDecoder)

  /**
   * Parses a org.http4s.internal.parboiled2.util.Base64.custom()-encoded string potentially containing newlines
