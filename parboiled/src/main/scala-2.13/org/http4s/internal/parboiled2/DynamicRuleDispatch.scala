...
object DynamicRuleDispatch {
  ...
  def __create[P <: Parser, L <: HList](c: Context)(
    ...
    c.Expr[(DynamicRuleDispatch[P, L], immutable.Seq[String])] {
      q"""val drd =
            new org.http4s.internal.parboiled2.DynamicRuleDispatch[$P, $L] {
              def apply(handler: org.http4s.internal.parboiled2.DynamicRuleHandler[$P, $L], ruleName: String): handler.Result =
